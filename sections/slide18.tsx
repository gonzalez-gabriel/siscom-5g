      ...
      <SlideContent className="text-center">
        <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8 ">
          <div className="space-y-3 sm:space-y-4 md:space-y-6">
            <p className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight text-balance">
              "El 5G no es solo la siguiente G.
            </p>
            <p className="text-xl sm:text-2xl md:text-3xl leading-relaxed text-muted-foreground text-balance">
            ...
            <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary leading-tight mt-6 sm:mt-8 md:mt-12 text-balance">
